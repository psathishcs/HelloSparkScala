...
object Problem1 {
  def main(args : Array[String]) {
    ...
    var sqlResult = sqlContext.sql("SELECT to_date(from_unixtime(cast(order_date/1000 as bigint))) as order_formatted_date, order_status, case(sum(order_item_subtotal) as DECIMAL(10, 2)) AS total_amount, " +
